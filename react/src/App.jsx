...
const Index = () => {
  ...
  const [authNav, setauthNav] = useState(1);
      ...
      try {
        await axios({
          ...
          Swal.fire({
            position: "top-end",
            icon: "success",
            title: res.data.messages.success,
            showConfirmButton: false,
            timer: 1500,
          });
        });
        ...
        Swal.fire({
          ...
          title:
            error.response.data.messages?.name ||
            error.response.data.messages?.img,
          showConfirmButton: false,
          timer: 1500,
        });
      }
  ...
  const submitChangePass = (e) => {
    e.preventDefault();
    if (inputCheck() === true) {
      handleAsyncApi("resetPass", {
        password: document.getElementById("password").value,
        uuid: GetURLParameter("resetPass"),
      });
    }
  };
  ...
  const submitSetting = (e) => {
    e.preventDefault();
    var data = new FormData(document.getElementById("createFormSetting"));
    handleAsyncApi("setting", data, dataUsers.uuid);
  };
  ...
  return (
    <>
      {loadingScreen && (
        <div
          style={{ zIndex: "9999" }}
          className=" fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-50 overflow-hidden bg-gray-700 opacity-100 flex flex-col items-center justify-center"
        >
      ...
      {GetURLParameter("resetPass") ? (
        <div className="lg:flex">
          <div className="lg:w-1/2 xl:max-w-screen-sm animate-fade-right">
            <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl mb-5">
              ...
              <div className="mt-12">
                <form id="createForm" onSubmit={submitChangePass}>
                  <div className="mt-8">
                    ...
                    />
                    <small>
                      Min 1 Lowercase, Min 1 Uppercase, Min 1 Number, Min 8 Char
                    </small>
        ...
        <>
          {!dataUsers?.email_verified_at && localStorage.getItem("token") ? (
            <div
              style={{ zIndex: "999" }}
            ...
            >
              <div className="flex justify-center items-center text-white font-bold text-2xl">
                Cek Your Email Verified Account
              </div>

              <button
                onClick={() => {
                  handleAsyncApi("email", {
                    email: dataUsers.email,
                    username: dataUsers.name,
                    uuid: dataUsers.uuid,
                  });
                }}
                className="bg-indigo-500 text-gray-100 p-3 w-36 mt-2 rounded-full tracking-wide
                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                                shadow-lg "
              >
                Send again
                ...
                <div className="lg:flex">
                  {authNav === 2 ? (
                        ...
                        <div className="mt-12">
                          <form id="createForm" onSubmit={submitSignUp}>
                            ...
                            <div className="mt-8">
                              ...
                              />
                              <small>
                                Min 1 Lowercase, Min 1 Uppercase, Min 1 Number,
                                Min 8 Char
                              </small>
                              <small
                                id="msgPassword"
                    ...
                    xl:text-bold"
                        ...
                        <div className="mt-12">
                          <form id="createForm" onSubmit={submitForgot}>
                            <div>
                              <div className="text-sm font-bold text-gray-700 tracking-wide">
                                Email Address
                              </div>
                  ...
                  <div className="bg-gray-800 flex-1 flex flex-col space-y-5 lg:space-y-0 lg:flex-row lg:space-x-10 max-w-6xl sm:p-6 sm:my-2 sm:mx-4 sm:rounded-2xl">
                    ...
                    {nav === "setting" && (
                      <div className="flex-1 px-2 sm:px-0">
                        ...
                        <form id="createFormSetting" onSubmit={submitSetting}>
                          <div className="mb-10 sm:mb-0 mt-10 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            <ImgUpload
                              name="img"
                              id="img"
